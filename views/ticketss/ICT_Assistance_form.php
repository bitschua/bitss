...
<div class="ictassistance-form">
    ...
    <table>
        <tbody>
            ...
            <td>
                <?= $form->field($model, 'date')->textInput(['style' => 'border: none; border-bottom: 2px solid black; outline: none;','placeholder' => 'Enter date','size' => 30,'id' => 'txtOthers']) ?>
            </td>
            ...
            <tr>
                <td><?= $form->field($model, 'property_no')->textInput(['maxlength' => true]) ?></td>
                <td>
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td><?= $form->field($model, 'diagnosis')->textarea(['rows' => 4, 'cols' => 50]) ?></td>
            </tr>
            <tr>
                <td><?= $form->field($model, 'action_taken')->textarea(['rows' => 4, 'cols' => 50]) ?></td>
            </tr>
        </tbody>
    </table>
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td><?= $form->field($model, 'acknowledge_by')->textInput(['maxlength' => true]) ?></td>
            ...
            <tr>
                ...
                <td>
                    <?= $form->field($model, 'date_of_approval')->textInput([
                    'style' => 'border: none; border-bottom: 2px solid black; outline: none;',
                    'placeholder' => 'Enter date',
                    'size' => 10,
                    'id' => 'txtOthers'
